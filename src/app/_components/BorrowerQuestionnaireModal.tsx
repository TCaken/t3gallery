...
import { createBorrowerNote, createBorrowerAction } from '~/app/_actions/borrowerNotes';
...
export default function BorrowerQuestionnaireModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Save questionnaire responses as a structured note (NOT as action)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      ...
      // Save questionnaire as a borrower note (so it appears in Notes & Communications)
  ...
  const handleSaveAndGoToAppointment = async () => {
    if (!borrower) return;

    try {
      setSaving(true);

      // Same save logic as handleSave - save as borrower note
      const questionnaireNote = `
CUSTOMER QUESTIONNAIRE:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📊 Financing Amount: ${formData.financing_amount}
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
      ...
      window.location.href = `/dashboard/borrowers/${borrower.id}/appointments`;
    } catch (error) {
      console.error('Error saving questionnaire:', error);
      alert('Failed to save questionnaire. Please try again.');
    } finally {
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {borrower.customer_experience_feedback && (
                    <div className="bg-blue-50 p-2 rounded">
                      ...
                      <p className="text-xs mt-1 italic">&ldquo;{borrower.customer_experience_feedback}&rdquo;</p>
                    </div>
                  )}
                </div>
              </div>
        ...
        <div className="flex justify-between items-center p-6 border-t border-gray-200 bg-gray-50 flex-shrink-0">
          ...
          <div className="flex space-x-3">
            ...
            <button
              onClick={handleSave}
              disabled={saving}
              className="flex items-center space-x-2 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 disabled:bg-green-300 transition-colors"
            >
              {saving ? (
                <>
            ...
            <button
              onClick={handleSaveAndGoToAppointment}
              disabled={saving}
            ...
            >
              {saving ? (
                ...
                <>
                  <CheckCircleIcon className="h-4 w-4" />
                  <span>Save & Go to Appointment</span>
                </>
              )}
            </button>
          </div>
