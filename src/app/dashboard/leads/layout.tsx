...
import { UserRoleContext } from './useUserRole';
import type { UserRole, UserRoleContextType } from './useUserRole';
    ...
    const loadUserRole = async () => {
      ...
      try {
        ...
        if (roles && roles.length > 0) {
          ...
          // Check if user has required permissions for leads section
